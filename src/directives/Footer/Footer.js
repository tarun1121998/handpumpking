            ...
            <Row>
              ...
              <Col lg={3} md={4}>
                ...
                <div className="footer-list">
                 ...
                 <Link to="/userprofile" > <li>Profile</li></Link> 
                  <Link to="/ConsumerComplaint">  <li>Contact Us</li></Link>
                    <li>Help</li>
                  </ul>
                </div>
              </Col>
              <Col lg={3} md={4}>
                ...
                <div className="footer-list">
                  <ul>
                    <li>
                      <i class="fa-solid fa-location-dot"></i> 367 Hillcrest
                      Lane, Irvine, California, United States
                    </li>
                    <li>
                      <i class="fa-solid fa-phone"></i> 9876543221
                    </li>
                    <li>
