                    ...
                    <div className="consumer">
                      <Row>
                        <Col lg={6}>
                          ...
                          />
                          <select value={selectServiceid} onChange={handlerservise}>
                        ...
                        <Col lg={6}>
                          ...
                          {/* ---------------- Select Category ------------- */}
                          <select  value={categoryid} onChange={handlercate}>
                        ...
                        <button className="btn btn-info" onClick={ConsumerComplaint}>
                          Submit
                        </button>
